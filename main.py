...
def main():
    st.set_page_config(page_title="Tender Generator", layout="wide")
    ...
    with st.form("tender_details"):
        ...
        with col1:
            ...
            duration = st.number_input("Project Duration (months)", min_value=1, value=12)

        with col2:
            budget = st.text_input("Project Budget (optional)")
